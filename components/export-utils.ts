...
export const exportDashboardSummaryPDF = (
 ...
 ["Total Income",
 formatFn(metrics.totalIncome)],

 ["Total Expenses",
 formatFn(metrics.totalExpenses)],

 ["Average Expense",
 formatFn(metrics.averageExpense)],

 ["Transactions",
 String(metrics.totalTransactions)],

 ["Notes",
 String(metrics.totalNotes)],

 ["Active Users",
 String(metrics.activeUsers)],

 ["Pending Users",
 String(metrics.pendingUsers)],

 ["Workspace Allocation",
 formatFn(metrics.workspaceAllocation)],

 ["Remaining Balance",
 formatFn(metrics.workspaceRemaining)],

 ["Transfers",
 String(metrics.transferCount)],

 ["Income Count",
 String(metrics.incomeCount)],

 ["Expense Count",
 String(metrics.expenseCount)]
 ...
 const categoryRows=
 metrics.categorySpendingData.map(
 (c:any)=>[
 c.name,
 formatFn(c.value)
 ])
